...
public class CCrudController01 extends SelectorComposer<Component> implements ItemRenderer<String> {
     ...
     * 
     */
    private static final long serialVersionUID = 3956844387875236695L;// La idea
                                                                      // de esto
                                                                      // es
                                                                      // crear
                                                                      // una
                                                                      ...
                                                                      // de
                                                                      // tareas
    // Decidí simplificar el ejemplo de zkoss porque se complica enormemente
    ...
    @Wire
    Listbox box;
    protected ListModelList<String> datamodeltarea = new ListModelList<String>();// Empezemos
                                                                                 // con
                                                                                 // simplificar
                                                                                 // el
                                                                                 // tipo
                                                                                 ...
                                                                                 // una
                                                                                 // cadena
    // ListModelList<tarea> TareaListModel;
    // ListModelList<prioridad> PrioridadListModel;
    // CTarea selectedTarea;
    ...
    public void onClickbuttonnew(Event event) {
        if ((textboxnuevo.getValue().equals("")) || (prioridad.getValue().equals(""))) {// Si
                                                                                        // uno
                                                                                        // de
                                                                                        // los
                                                                                        // dos
            ...
            Messagebox.show("Error, tarea vacía o prioridad no seleccionada. Acción cancelada", "Aceptar",
                    Messagebox.OK, Messagebox.EXCLAMATION);// Damos mensaje de
                                                           // error
            index.setValue(String.valueOf(box.getSelectedIndex()));// Esto
                                                                   // simplemente
                                                                   // lo hice
                                                                   // por tratar
                                                                   // de depurar
                                                                   // un error
            // muestra el índice seleccionado
        } else {// sino
            Messagebox.show("Tarea agregada", "Aceptar", Messagebox.OK, Messagebox.EXCLAMATION);// Damos
                                                                                                // mensaje
                                                                                                // de
                                                                                                // éxito
            datamodeltarea.add((prioridad.getValue() + " " + textboxnuevo.getValue()));// Añadimos
                                                                                       // la
                                                                                       // tarea
    ...
    public void onSelectBox(Event event) {
        String test = "";
        test = datamodeltarea.getSelection().toString();// Se copia a una
                                                        // variable local
        textboxnuevo.setValue(test);// Se muestra en la caja de texto, aunque no
                                    // se por que salen
                                    // brackets []
        index.setValue(String.valueOf(box.getSelectedIndex()));
    }
